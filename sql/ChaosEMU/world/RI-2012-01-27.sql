...
(63792,'spell_gen_summon_argent_mount');-- remove aura_required for clickspells on tournament mounts and add more cases (Thanks to @Tassader)
...
(63792,'spell_gen_summon_tournament_mount');DELETE FROM `spell_script_names` WHERE `spell_id` IN (62552,62719,66482);
INSERT INTO `spell_script_names`(`spell_id`,`ScriptName`) VALUES
...
INSERT INTO `spell_script_names`(`spell_id`,`ScriptName`) VALUES
(62863 ,'spell_gen_tournament_duel');DELETE FROM `achievement_criteria_data` WHERE `criteria_id`=9798 AND `type`=11; 
INSERT INTO `achievement_criteria_data` (`criteria_id`,`type`,`value1`,`value2`,`ScriptName`) VALUES 
(9798,11,0,0, 'achievement_tilted'); 
-- http://www.wowhead.com/quest=12893/free-your-mind
UPDATE `creature_template` SET ScriptName = 'npc_free_your_mind' WHERE `entry` IN (29769,29770,29840);UPDATE `creature_template` SET `ScriptName`='npc_ValiantGrandMelee' WHERE `entry` IN (33306,33382,33383,33384,33385,33561,33558,33559,33562);