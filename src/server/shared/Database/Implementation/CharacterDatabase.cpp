...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PREPARE_STATEMENT(CHAR_DEL_ARMERIA_STATS, "DELETE FROM armory_character_stats WHERE guid = ?", CONNECTION_ASYNC);
    PREPARE_STATEMENT(CHAR_DEL_FEED_LOGS, "DELETE FROM character_feed_log WHERE guid = ?", CONNECTION_ASYNC);
