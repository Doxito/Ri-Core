...
#define EMOTE_TYMPANIC "El Deconstructor empieza a golpear el suelo."
#define EMOTE_HEART    "El coraz""\xC3\xB3""n del Deconstructor acaba de aparecer."
#define EMOTE_REPAIR   "El Deconstructor acaba de recuperar salud consumiendo la chatarra."
